...
if __name__=='__main__':
    ...
    AMS_data = np.loadtxt("Data/AMS_data.dat",skiprows=2)
    HESS_data = np.loadtxt("Data/HESS_data.dat",skiprows=2)
    Fermi_data = np.loadtxt("Data/Fermi_data.dat",skiprows=2)
    AMS_positron_fraction = np.loadtxt("Data/AMS_positron_fraction.dat",skiprows=2)
    PAMELA_positron_fraction = np.loadtxt("Data/PAMELA_positron_fraction.dat",skiprows=2)
    
    # Curves from other papers
    Yuksel_delta04 = np.loadtxt("Data/Yuksel_Fig3_dotted_delta04.csv",delimiter=',')
    Aharonian_Fig4 = np.loadtxt("Data/Aharonian_Fig_4_time_dependent_injection.csv",skiprows=1)
    #AMS_data = np.loadtxt("Data/AMS_data.dat",delimiter=',')
    #AMS_data = np.loadtxt("Data/AMS_data.dat",delimiter=',')
    ...
    primary_el_data = np.loadtxt("Data/Primary_electrons.txt",skiprows=1)
    secondary_el_data = np.loadtxt("Data/Secondary_electrons.txt",skiprows=1)
    secondary_pos_data = np.loadtxt("Data/Secondary_positrons.txt",skiprows=1)
